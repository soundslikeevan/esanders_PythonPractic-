...
#my_number = int(input("Enter a number between 0 and 99: "))

#if int(my_number) < 5:
#    print("Your number is less than 5.")
#elif int(my_number) == 5:
...
#elif my_number > 10 and my_number < 100:
#    print("This is a Double Digit Number")
#else:
#    print("This number is larger than the expected range. ")
...
Player_1 = input("Player 1 turn: ")
Player_2 = input("Player 2 turn: ")
...
print("Please create a password to access information. Password must be a minimum of 9 characters and contain an uppercase character, lowercase character, a number, and a special character. ")

password = input("Please create password: ")

pw_list = list(password)
qualifiers = ["An Uppercase Character", "A Lowercase Character", "A Number", "A Special Character"]

for i in pw_list:
    if i.isupper():
        if "An Uppercase Character" in qualifiers:
            qualifiers.remove("An Uppercase Character")
    elif i.islower():
        if "A Lowercase Character" in qualifiers:
            qualifiers.remove("A Lowercase Character")
    elif i.isnumeric():
        if "A Number" in qualifiers:
            qualifiers.remove("A Number")
    elif i in string.punctuation:
        if "A Special Character" in qualifiers:
            qualifiers.remove("A Special Character")

if len(qualifiers) == 0 and len(pw_list) >= 9:
    print("Your password meets the minimum requirements.")

if len(qualifiers) != 0:
     print("Your password must contain the following: " + ", ".join(qualifiers))

if len(pw_list) < 9:
    print("Your password must be a minimum of 9 characters")